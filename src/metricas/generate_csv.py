...
video_path = r'C:\Users\SimIA\Documents\proyecto_RCP_IA\data\videos\ya_entrenado\5.mp4' # 2 12, testear 9 10 gineco
...
with open(csv_path+"/predictions_video_5.csv", "w", newline="") as csvfile:
